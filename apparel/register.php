...
<div class="container">
	...
	<div align="center">
		<form method="post" action="approvedEmail1.php">
			<div class="input">
				<label style="font-weight: normal; font-size: 13px;">Please enter your IC number and email to register.</label>
			</div>
			<div class="input">
			...
			<div class="input">
				<label> Email :</label>
				<input type="text" name="emp_email" id="emp_email" required>
			</div>

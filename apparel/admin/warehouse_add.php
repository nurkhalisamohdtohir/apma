...
<html>
<head>
    <title>New Warehouse | Admin</title>
...
?>
    ...
    <div class="w3-container"> 
        ...
        <div class="title">
            <h2><b>Add Warehouse</b></h2><hr>
        </div>

        <div class="form-box">
            <!-- <div class="form-left"> -->
                <form role="form"  action="warehouse_data.php" method="POST">


                    <div class="form">
                        <label><b>Location : </b></label>
                        <input type="text" name="Warehouse_Location" required style="text-transform:uppercase">
                    </div>

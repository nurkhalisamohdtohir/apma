...
<html>
<head>
    <title>Production List | Admin</title>
...
?>
    ...
    <div class="w3-container"> 
        ...
        <div class="w3-card-4" style="width:100%;">
            <hr>
            <a href="production_add.php" class="w3-button w3-circle w3-gray" style="font-size: 20px; float:right; margin-right: 50px;"><i class="fa fa-plus"></i></a><br><br><br>
    ...
    <div class="div-table">
        ...
        { ?>
                <tr class="tbody" id="MyTable">
                    ...
                    <a href="production_update.php?Production_ID=<?php echo $row1['Production_ID'] ?>"><button type='button'><i class="fas fa-edit"></i></button></a> 
                    <a href="production_delete.php?Production_ID=<?php echo $row1['Production_ID'] ?>"><button type='button'><i class="fas fa-trash"></i></button></a>   

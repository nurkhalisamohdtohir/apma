...
<!-- Search filter -->
        <div class="form" method='post' action=''>
            ...
            <select class="prefer" name="filter" id="filter" style="width: 12%"><br>
                ...
                <option value="production_process"> PRODUCTION </option>
            ...
            <select class="prefer" name="choice" id="choice" style="width: 20%" ><br>
                ...
                <?php
                        ...
                        {
                        echo "<option class='production_process' value='". $data['Process_ID'] ."'>".$data['Process_Desc'] ."</option>";  // displaying data in option menu
                        }   
                    ?>  
                <?php
                        ...
                        while($data = mysqli_fetch_array($records))
                        {
                        echo "<option class='pattern' value='". $data['Pattern_ID'] ."'>".$data['Pattern_Type'] ."</option>";  
                        }   
                    ?>  
                <?php

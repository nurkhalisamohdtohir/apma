...
<html>
<head>
    <title>Process List | Admin</title>
...
<content>
  <center>
    <div class="title">
      <h2><b>List of Production Process</b></h2><hr>
    </div>
    ...
    <div class="div-table">
            <table class= "w3-table-all w3-hoverable" style="text-align: left; border: 1">
              <tr><input id="search" style="width: 30%; height: 30px;font-size: 15px;" type="text" placeholder="Search.."></tr><br><br>
                <tr class="w3-light-grey">
                    <th width="2%">No</th>
                    <th width="40%">Production Process</th>
        ...
        { ?>
                <tr class="tbody" id="MyTable">
                    ...
                    <td><a href="process_view.php?Process_ID=<?php echo $row1['Process_ID'] ?>"><button type='button'><i class="fas fa-eye"></i></button></a> 
                    <a href="process_update.php?Process_ID=<?php echo $row1['Process_ID'] ?>"><button type='button'><i class="fas fa-edit"></i></button></a> 
                    <a href="process_delete.php?Process_ID=<?php echo $row1['Process_ID'] ?>"><button type='button'><i class="fas fa-trash"></i></button></a>   

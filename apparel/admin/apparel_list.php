...
<html>
<head>
    <title>Apparel List | Admin</title>
...
?>
    ...
    <div class="w3-container"> 
        ...
        <div class="w3-card-4" style="width:100%;">
            <hr>
            <a href="apparel_add.php" class="w3-button w3-circle w3-gray" style="font-size: 20px; float:right; margin-right: 50px;"><i class="fa fa-plus"></i></a><br><br><br>
...
<content>
  <center>
    ...
    <div class="div-table">
        ...
        $counter = 1;
        $sql="SELECT apparel.Apparel_ID, apparel.Apparel_Code, apparel.Apparel_Name, pattern.Pattern_ID, pattern.Pattern_Code, fabric.Fabric_ID, fabric.Fabric_Code, apparel.Apparel_Price, apparel.Apparel_Qty, 
        IFNULL((SELECT SUM(inventory.Quantity) FROM inventory WHERE apparel.Apparel_ID=inventory.Apparel_ID), 0) as Apparel_QtyD, 
        IFNULL(apparel.Apparel_Qty - (SELECT SUM(inventory.Quantity) FROM inventory WHERE apparel.Apparel_ID=inventory.Apparel_ID), 0) as Apparel_QtyRS, apparel.Apparel_Image, production.Production_ID
FROM apparel 
...
GROUP BY apparel.Apparel_ID";
        ...
        { ?>
                <tr class="tbody" id="MyTable">
                    ...
                    <a href="apparel_update.php?Apparel_ID=<?php echo $row1['Apparel_ID'] ?>"><button type='button'><i class="fas fa-edit"></i></button></a> 
                    <a href="apparel_delete.php?Apparel_ID=<?php echo $row1['Apparel_ID'] ?>"><button type='button'><i class="fas fa-trash"></i></button></a>   

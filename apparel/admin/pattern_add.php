...
$query = "SELECT Pattern_Code FROM pattern ORDER BY Pattern_Code DESC";
$result = mysqli_query($conn,$query);
$row = mysqli_fetch_array($result);
$lastid = $row['Pattern_Code'];
if(empty($lastid))
{
    $number = "P01";
}
...
?>
    ...
    <div class="w3-container"> 
        ...
        <div class="title">
            <h2><b>Add Pattern</b></h2><hr>
        </div>

        <div class="form-box">
            <!-- <div class="form-left"> -->
                <form role="form"  enctype="multipart/form-data" action="pattern_data.php" method="POST">

                    <div class="form">
                        <label><b>Code : </b></label>
                        <input type="text" name="Pattern_Code" value="<?php echo $number; ?>" readonly>
                    </div>

                    <div class="form">
                        <label><b>Type : </b></label><br>
                        <input type="text" name="Pattern_Type" required style="text-transform:uppercase">
                    </div>

                    <div class="form">
                        <label><b>Meters Needed (m) : </b></label><br>
                        <input type="text" name="Pattern_Meter" required>
                    </div>

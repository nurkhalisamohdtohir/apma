...
<content>
  <center>
    ...
    <div class="div-table">
        ...
        $counter = 1;
        $sql="SELECT *, fabric.Fabric_Qty*60 as totalQty, (fabric.Fabric_Qty*60 - (SELECT SUM(Apparel_Qty*2) FROM apparel WHERE fabric.Fabric_ID=apparel.Fabric_ID)) as balance
        FROM `fabric`";
